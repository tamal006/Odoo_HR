...
async def main() -> None:
    # sys.executable, not "python3": the latter doesn't exist on Windows.
    params = StdioServerParameters(command=sys.executable, args=["mock_odoo_mcp_server.py"], env=None)
